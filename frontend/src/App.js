...
//               <Route
//                 path="update-profile"
//                 element={token ? <UpdateProfile token={token} /> : <Navigate to="/login" />}
//               />
//               <Route
//                 path="courses"
//                 element={token ? <CourseList token={token} /> : <Navigate to="/login" />}
//               />
//               <Route
//                 path="create-course"
//                 element={token ? <CourseCreate token={token} /> : <Navigate to="/login" />}
//               />
//               <Route
//                 path="edit-course/:id"
//                 element={token ? <EditCourse token={token} /> : <Navigate to="/login" />}
//               />
        ...
        <div className="mt-3 mx-3">
          <Routes>
            <Route path="/" element={<Layout token={token} setToken={setToken} />}>
              ...
              <Route path="courses" element={token ? <CourseList token={token} role={role} /> : <Navigate to="/login" />} />
